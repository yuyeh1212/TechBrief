...
async def init_db():
    from app.models import article, subscriber, weekly_report, stock_analysis_cache, stock_query_log  # noqa: F401
    async with engine.begin() as conn:
        ...
        await conn.execute(text("ALTER TABLE articles ADD COLUMN IF NOT EXISTS sentiment VARCHAR(20)"))
